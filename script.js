...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])('.accordion-heading'); // accordion('.accordion-heading', '.accordion-block');
...
var calc = function calc(size, material, options, promo, result) {
  ...
  var calcSum = function calcSum() {
    ...
    if (sizeBlock.value === '' || materialBlock.value === '') {
      resultBlock.textContent = 'Please, choose any pictures size and material';
...
var filter = function filter() {
  var menu = document.querySelector('.portfolio-menu'),
      ...
      btnGrandfa = menu.querySelector('.granddad'),
  ...
  btnGrandfa.addEventListener('click', function () {
    typeFilter();
  });
...
var forms = function forms() {
  ...
  var message = {
    loading: 'Download',
    success: 'Thanks!Our manager calls you...',
  ...
  var clearInputs = function clearInputs() {
    ...
    upload.forEach(function (item) {
      item.previousElementSibling.textContent = 'Choose file';
    });
  };
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  //    cards.forEach(card => {
  //       card.classList.remove('hidden-lg', 'hidden-md', 'hidden-xs', 'hidden-sm');
  ...
  btn.addEventListener('click', function () {
    ...
    this.classList.add('animated', 'fadeOutDown');
    setTimeout(function () {
      _this.remove();
    }, 1000);
  });
...
var sliders = function sliders(slidesSelector, direction, previous, next) {
  var slideIndex = 1,
      paused = false;
